...
## Basic Commands <a href="#basic" id="basic"></a>

* [Help](basic/help.md)
* [Set Base Currency](basic/base-currency.md)
* [Set Decimal Separator](basic/decimal-separator.md)

## Manually Conversion <a href="#convert" id="convert"></a>

* [Overview](convert/overview.md)
* [Convert To Base Currency](convert/convet-to-base-currency.md)
* [Manually Convert](convert/manual-conversion.md)
...
* [Currency Alias](glossary/alias.md)
